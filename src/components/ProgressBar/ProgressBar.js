...
import MeditatorIcon from "assets/meditation.png";
...
function ProgressBar({ duration, currentTime, playing, theme }) {
  ...
  let strokeColor;
  const color = {
    ocean: { progress: "#00E8FF", stroke: "#122536" },
    mountain: { progress: "#BC5638", stroke: "#141A1C" },
    rain: { progress: "#072F5F", stroke: "#342C3C" },
  };
